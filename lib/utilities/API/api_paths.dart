...
class APIPaths {
  ...
  static String pickups = mainDirection + "/api/v1/pickups";
  static String pickupsLocation = mainDirection + "/api/v1/pickup-locations";
  static String cities = mainDirection + "/api/v1/cities";
  static String areas = mainDirection + "/api/v1/areas";
}
